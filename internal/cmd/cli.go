...
import (
	...
	"github.com/theunrepentantgeek/make-graph/internal/autocolor"
	"github.com/theunrepentantgeek/make-graph/internal/config"
	"github.com/theunrepentantgeek/make-graph/internal/dot"
	"github.com/theunrepentantgeek/make-graph/internal/graph"
	"github.com/theunrepentantgeek/make-graph/internal/graphviz"
	"github.com/theunrepentantgeek/make-graph/internal/makegraph"
	"github.com/theunrepentantgeek/make-graph/internal/mermaid"
...
type CLI struct {
	Makefile string `arg:"" help:"Path to the Makefile to process." default:"Makefile"`
	...
	GroupByNamespace bool `help:"Group targets in the same namespace together in the output." long:"group-by-namespace"`
...
func (c *CLI) Run(
	...
	if err != nil {
		return eris.Wrap(err, "failed to parse Makefile")
	}
	...
	if c.RenderImage != "" {
		if err = c.renderImage(context.Background(), flags); err != nil {
			return err
		}
	}

	if c.ExportConfig != "" {
		if err = c.ExportConfigToFile(flags.Config); err != nil {
			return err
		}
	}
